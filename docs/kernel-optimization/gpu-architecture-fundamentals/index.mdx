...
[Kernel optimization](/kernel-optimization/kernel-optimization-for-llm-inference/)
...
- A
  [thread](/kernel-optimization/gpu-architecture-fundamentals/threads-warps-blocks/#threads)
...
- A
  [streaming multiprocessor (SM)](/kernel-optimization/gpu-architecture-fundamentals/streaming-multiprocessors/#what-an-sm-contains)
